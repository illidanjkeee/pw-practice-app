...
test.describe("IoT Dashboard Tests, Light Functionality", () => {
  ...
  test("should verify the light functionality title", async ({ IoTDashboardPage }) => {
...
test.describe("IoT Dashboard Tests, Roller Shades Functionality", () => {
  ...
  test("should toggle the roller shades on and off", async ({ IoTDashboardPage }) => {
  ...
  test("should verify the roller shades status", async ({ IoTDashboardPage }) => {
    await test.step("Check the roller shades status", async () => {
      const rollerShadesStatusText = IoTDashboardPage.rollerShadesStatus;
      await expect(rollerShadesStatusText).toHaveText(rollerShadesStatusText ? "ON" : "OFF");
    });
  });

  test("should verify the roller shades functionality title", async ({ IoTDashboardPage }) => {
...
test.describe("IoT Dasboard Tests, Wireless Audio Functionality", () => {
  ...
  test("should verify the wireless audio functionality title", async ({ IoTDashboardPage }) => {
  ...
  test("should verify the wireless audio status", async ({ IoTDashboardPage }) => {
    await test.step("Check the wireless audio status", async () => {
      const wirelessAudioStatusText = IoTDashboardPage.wirelessAudioStatus;
      await expect(wirelessAudioStatusText).toHaveText(wirelessAudioStatusText ? "ON" : "OFF");
    });
  });

  test("should toggle the wireless audio on and off", async ({ IoTDashboardPage }) => {
...
test.describe("IoT Dashboard Tests, Coffee Maker Functionality", () => {
  ...
  test("should verify the coffee maker functionality title", async ({ IoTDashboardPage }) => {
  ...
  test("should verify the coffee maker status", async ({ IoTDashboardPage }) => {
    await test.step("Check the coffee maker status", async () => {
      const coffeeMakerStatusText = IoTDashboardPage.coffeeMakerStatus;
      await expect(coffeeMakerStatusText).toHaveText(coffeeMakerStatusText ? "ON" : "OFF");
    });
  });

  test("should toggle the coffee maker on and off", async ({ IoTDashboardPage }) => {
